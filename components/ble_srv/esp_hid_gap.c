...
//use bluedroid stack and enable  ble (use target is esp32s3)
...
//this true only using taget have classic bluetooth capacity and enable hid function and use bluedroid stack
...
//bluedroid and enbale ble (using target is esp32s3)
#if CONFIG_BT_BLE_ENABLED
...
//use bludroid stack and use ble (in the case of use target chip is esp32s3!!)
#if CONFIG_BT_BLE_ENABLED
/*
 * BLE GAP
 * */
